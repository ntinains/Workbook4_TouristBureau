...
// Category Pre-selected option// 
let selectDefaultOption = new Option("Select One"); // text to show pre-selected option //
selectCategoriesEl.appendChild(selectDefaultOption);
selectCategoriesEl.options[0].selected = true; // set position to select 1st option
